...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Text = L"Введите номера вершин, смежных с данной";
			// 
			// button1
			// 
			this->button1->DialogResult = System::Windows::Forms::DialogResult::OK;
			this->button1->Location = System::Drawing::Point(85, 73);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(15, 37);
			...
			this->ClientSize = System::Drawing::Size(253, 114);
			...
			this->Name = L"AddForm";
			this->Text = L"Добавление вершины";
